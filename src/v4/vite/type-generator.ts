/**
 * Generates TypeScript type definitions from extracted theme
 */
...
export function generateTypeDeclarations(
  ...
  typeDefinitions.push(' *');
  typeDefinitions.push(
    ' * This file is automatically generated by tailwind-theme-extractor.',
  );
  typeDefinitions.push(
  ...
  typeDefinitions.push("declare module 'tailwind-theme-extractor' {");
