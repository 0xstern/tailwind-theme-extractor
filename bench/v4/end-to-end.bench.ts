...
const fixturesPath = join(import.meta.dir, '../../__tests__/v4/fixtures');

const fixtures = {
  minimal: join(fixturesPath, 'base-theme.css'),
  medium: join(fixturesPath, 'custom-themes.css'),
  large: join(fixturesPath, 'shadcn-global.css'),
  tailwindDefaults: join(fixturesPath, 'default-theme.css'),
  shadcnThemes: join(fixturesPath, 'shadcn-themes.css'),
  complexFunctions: join(fixturesPath, 'complex-css-functions.css'),
  nestedVariants: join(fixturesPath, 'nested-variant.css'),
